...
def load_data(data='./data/', data_static='./data_static/') -> bool:
    '''
    Load the data from the data and data_static folders and put them in different DataFrames that will be later used by
    the other functions.
